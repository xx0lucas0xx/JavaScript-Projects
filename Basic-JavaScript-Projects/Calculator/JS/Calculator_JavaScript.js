...
const Calculator = {
    ...
    First_Operand: null,
    //This cheks wether or not the second operand has been inputted by the user.
...
function Handle_Operator(Next_Operator) {
    ...
    if(First_Operand == null) {
        ...
        //Here we add a fixed amoung of numbers after the decimal.
...
//This function udates the calculator screen with the contents of Display_Value
...
keys.addEventListener ('click', (event) => {
    ...
    //that was clicked.
    const {target} = event;
    //If the element that was clicked on is not at button, exit the function
    ...
    //Ensures that SC clears all inputs the Calculator screen.
